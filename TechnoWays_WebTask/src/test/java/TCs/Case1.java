...
public class Case1 {
	...
	utils.LogInFile Logger = new utils.LogInFile(Case1.class);

	@Test
	public void SearchBy_SeleniumTutorial_Display3rdVideo() {
		try {
			System.out.println("-------------\n:@Test Case1: SearchBy_SeleniumTutorial and Display 3rd Video");
...
//		System.out.println("TC DisplayedVideoTitle is: "+DisplayedVideoTitle);//for Test
			...
			System.out.println("-------------\n:Result: Case1 Pass successfully.\n-------------");
